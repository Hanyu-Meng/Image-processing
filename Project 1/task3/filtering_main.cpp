...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (n = 0; n < num_comps; n++)
            input_comps[n].init(height, width, filter_length); 
        ...
        for (n = 0; n < num_comps; n++)
            output_comps[n].init(output_height, output_width, 0); // Don't need a border for input
        ...
        if (mode == 0) {
            ...
            for (n = 0; n < num_comps; n++)
                inter_comps[n].init(output_height, width, filter_length);
