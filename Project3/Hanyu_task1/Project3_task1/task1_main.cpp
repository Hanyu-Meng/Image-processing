...
void threshold_processing(my_image_comp* in, my_image_comp* out, float T) {
    int r, c;
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (n = 0; n < num_comps; n++)
            input_comps[n].init(height, width, 0); // Do not need to extent
      ...
      //  clock_t start_time = clock();
        ...
        for (n = 0; n < num_comps; n++) 
            threshold_processing(input_comps + n, output_comps + n, T);
